...
public class FromToTestIT {
	...
	public void offset() {
		...
		Assert.assertEquals(fromto.offset(), new Integer("11"));
		fromto = new FromTo(Optional.ofNullable("0"), Optional.ofNullable("15"));
		Assert.assertEquals(fromto.offset(), new Integer("16"));
		fromto = new FromTo(Optional.ofNullable("0"),
				Optional.ofNullable("+15"));
		Assert.assertEquals(fromto.offset(), new Integer("15"));
		fromto = new FromTo(Optional.ofNullable("0"),
				Optional.ofNullable("  +15	"));
		Assert.assertEquals(fromto.offset(), new Integer("15"));
		fromto = new FromTo(Optional.ofNullable(" 0   "),
		...
		Assert.assertEquals(fromto.offset(), new Integer("5"));
